...
def genera_master_aeropuertos():
    ...
    # 1. Filtro por tipo  de aeropuertocomercial (Grandes y Medianos) 
    ...
    # 5. Eliminar duplicados si los hubiera en la clave primaria (ident)
    df_master = df_master.dropna(subset=['ident']).drop_duplicates(subset=['ident'])
    
    # Guardar el Maestro Global en la raíz del proyecto
